...
export function createIngestRouter(queue: ReceiptQueue): Router {
  ...
  router.get('/james/receipts', async (req, res) => {
    if (!authorize(req, res)) return;
  ...
  router.get('/james/receipts/:eventId', async (req, res) => {
    if (!authorize(req, res)) return;
  ...
  router.patch('/james/receipts/:eventId', async (req, res) => {
    if (!authorize(req, res)) return;
  ...
  router.delete('/james/receipts/:eventId', async (req, res) => {
    if (!authorize(req, res)) return;
